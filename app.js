...
app.post("/compose", (req,res) => {
  const postTitle = lodash.startCase(lodash.lowerCase(req.body.composeTitle));
  const postContent = req.body.composeContent;
  Post.findOne({title: postTitle},(err,foundPost)=>{
    if(!foundPost){
      ...
      console.log("Title exists already please choose different one!");
...
app.get("/posts/:postName", (req,res) => {
  ...
  reqTitle = lodash.startCase(reqTitle);
